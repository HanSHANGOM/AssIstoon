...
class MaskRCNN():
    ...
    def __init__(self, mode, config, model_dir):
        ...
        configproto = tf.ConfigProto(log_device_placement=True,allow_soft_placement=True)
        configproto.gpu_options.allow_growth = True
        configproto.gpu_options.per_process_gpu_memory_fraction=0.9
    ...
    def build(self, mode, config):
        ...
        w = config.IMAGE_SHAPE[1]
        
        if h //64 != int(h / 64) or w // 64 != int(w / 64):
